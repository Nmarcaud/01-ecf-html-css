...
<main class="news-page-main-content">
    ...
    <!-- Section actualité -->
    <section class="news-text-content">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <img class="news-img" src="img/clavier_min.webp" srcset="img/clavier@2x_min.webp 2x" alt="Clavier d'ordinateur noir rétroéclairé en bleu">
                </div>
                <div class="col-12 col-md-10 col-lg-8 text-center">
                    <h1 class="page-title">Lorem ipsum dolor sit amet, consetetur sadipscing elitr</h1>
                </div>
                <div class="col-12 col-md-10 col-lg-8 text-center">
