    ...
    <div class="container">
        ...
        <div class="row justify-content-center pt-5">
            <div class="col-10">
                ...
                <form id="contact-form" class="contact-form" action="#" metod="post">
                    <div class="row gy-5 g-lg-5">
                        ...
                        <div class="col-12">
                            ...
                            <textarea type="text" class="form-control textarea" id="message" name="message" rows="8" placeholder="Tapez votre message"></textarea>
                        </div>
